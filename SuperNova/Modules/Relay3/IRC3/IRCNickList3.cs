...
using SuperNova.Modules.Relay3;
...
{    
    ...
    sealed class IRCNickList3 
    {
        ...
        public bool VerifyNick(string channel, string userNick, ref string error, ref bool foundAtAll) {
            ...
            IRCControllerVerify3 verify = Server.Config.GlobalIRCVerify;
            if (verify == IRCControllerVerify3.None) return true;
            
            if (verify == IRCControllerVerify3.HalfOp) {
