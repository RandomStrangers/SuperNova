...
{
    public enum IRCControllerVerify3 { None, HalfOp, OpChannel };
    
    /// <summary> Manages a connection to an IRC server, and handles associated events. </summary>
    public sealed class IRCBot3 : RelayBot3 
    {
        ...
        public override string RelayName { get { return "IRC3"; } }
        ...
        void OnPrivate(UserInfo user, string message) {
            RelayUser3 rUser = new RelayUser3();
            rUser.ID        = user.Nick;
        ...
        void Authenticate() {
            ...
            if (Server.Config.IRCIdentify && Server.Config.GlobalIRCPassword.Length > 0) {
