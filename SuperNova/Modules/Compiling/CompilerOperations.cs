...
namespace SuperNova.Modules.Compiling
{
    public static class CompilerOperations
    {
        ...
        public static System.CodeDom.Compiler.CompilerResults Compile(Player p, ICompiler compiler, string type, string[] srcs, string dst)
        {
            ...
            System.CodeDom.Compiler.CompilerResults results = Compile(p, compiler, type, srcs, dst) ;
        ...
        static void SummariseErrors(System.CodeDom.Compiler.CompilerResults results, string[] srcs, Player p)
        {
            int logged = 0;
            foreach (ICompilerError err in results.Errors)
            {
